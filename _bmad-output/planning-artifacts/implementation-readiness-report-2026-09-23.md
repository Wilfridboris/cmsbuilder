...
| U2 | **Stale branding** — design.md is titled "DashForge" and uses `admin.dashforge.ca` / `snow-pros.ca` URLs. | 🟢 Low (cosmetic) | Canonical product is **SnapBusy** at `snapbusy.ca/{slug}`; ignore DashForge naming/URLs. |
